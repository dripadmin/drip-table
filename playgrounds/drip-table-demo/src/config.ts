...
const treeTableToolbarLeft = ref<DripTableToolbarConfig>({
  actions: [
    {
      label: "打印",
      type: "primary",
    ...
    { label: "全部折叠", type: "danger", event: "collapseAll"},
  ],
});
